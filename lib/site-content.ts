...
export const siteContent: Record<Locale, SiteDictionary> = {
  id: {
    ...
    customers: {
      ...
      items: [
        "PT Raja Samudra Jaya (Area Kerja PT. Kalidareh Prima Mandiri, Bayung Lencir, Sumatera Selatan)",
        "PT Putri Melati Asih (Area Kerja PLTU Ombilin, Sawah Lunto, Padang, Sumatera Barat)",
        "PT Soga Teknik Utama (Area Kerja PT. Pupuk Sriwijaja, Palembang, Sumatera Selatan)",
        "PT Energate Prima Indonesia (Desa Prambatan, Kel. Abab, Kec. Penukal Abab, Kab. PALI, Sumatera Selatan)",
        "PT Madya Utama Lima (Desa Kerta Dewa, Kec. Talang Ubi, Kab. PALI, Sumatera Selatan)",
        "PT Rasita Anugrah Mulia (Site PT. RAM Belani, Muaratara, Sumatera Selatan)",
        "PT Global Integra Energy (Desa Prambatan, Kel. Abab, Kec. Penukal Abab, Kab. PALI, Sumatera Selatan)",
        "PT Sumatera Bara Utama (IUP PT. TMP, Desa Kota Raya, Kec. Lahat, Kab. Lahat, Sumatera Selatan)",
        "PT MNC Infrastruktur Utama (Site APE Arthaco Prima Energy, Babat Supat, Musi Banyuasin, Sumatera Selatan)",
        "PT GH EMM Indonesia (Dusun II, Desa Gunung Raja, Kec. Rambang Dangku, Kab. Muara Enim, Sumatera Selatan)",
        "PT Royaltama Mulia Kontraktorindo, Tbk (Emplasemen RMKO, Jalan Lintas Prabumulih – Muara Enim No. 16, Gn. Megang Dalam, Kec. Gn. Megang, Kab. Muara Enim, Sumatera Selatan 31352)",
        "PT RMK Energy, Tbk (Jalan TPA RT. 33, Keramasan Musi 2, Kec. Kertapati, Kota Palembang, Sumatera Selatan 30149)",
        "PT Keza Lintas Buana (Gn. Cahya, Kec. Buay Rawan, Kab. OKU Selatan, Sumatera Selatan 32211)",
        "PT Agro Gading Sejahtera (Gn. Cahya, Kec. Buay Rawan, Kab. OKU Selatan, Sumatera Selatan 32211)",
        "PT Mega Hijau Bersama (Site MHBK: Desa Kepayang & Site MHBM: Desa Merang, Kec. Bayung Lencir, Kab. Musi Banyuasin, Sumatera Selatan)",
        "PT Binakarya Eramandiri (Desa Mangsang, Kec. Bayung Lencir, Kab. Musi Banyuasin, Sumatera Selatan)",
        "PT Arwana Anugerah Keramik (Jalan Raya Palembang – Prabumulih KM. 34, Tanjung Pering, Indralaya Utara, Ogan Ilir, Sumatera Selatan)",
        "PT Buana Global Mandiri (Proyek Jalan Tol Trans Sumatera Ruas Betung, Simpang Sekayu Tempino – Jambi Seksi 2B)",
      ],
      note:
  ...
  en: {
    ...
    customers: {
      ...
      items: [
        "PT Raja Samudra Jaya (Work Area of PT. Kalidareh Prima Mandiri, Bayung Lencir, South Sumatra)",
        "PT Putri Melati Asih (Work Area of PLTU Ombilin, Sawah Lunto, Padang, West Sumatra)",
        "PT Soga Teknik Utama (Work Area of PT. Pupuk Sriwijaja, Palembang, South Sumatra)",
        "PT Energate Prima Indonesia (Prambatan Village, Abab Subdistrict, Penukal Abab, PALI Regency, South Sumatra)",
        "PT Madya Utama Lima (Kerta Dewa Village, Talang Ubi Subdistrict, PALI Regency, South Sumatra)",
        "PT Rasita Anugrah Mulia (Site of PT. RAM Belani, Muaratara, South Sumatra)",
        "PT Global Integra Energy (Prambatan Village, Abab Subdistrict, Penukal Abab, PALI Regency, South Sumatra)",
        "PT Sumatera Bara Utama (IUP PT. TMP, Kota Raya Village, Lahat Subdistrict, Lahat Regency, South Sumatra)",
        "PT MNC Infrastruktur Utama (APE Arthaco Prima Energy Site, Babat Supat, Musi Banyuasin, South Sumatra)",
        "PT GH EMM Indonesia (Dusun II, Gunung Raja Village, Rambang Dangku Subdistrict, Muara Enim Regency, South Sumatra)",
        "PT Royaltama Mulia Kontraktorindo, Tbk (RMKO Emplacement, Lintas Prabumulih – Muara Enim St. No. 16, Gn. Megang Dalam, Gn. Megang Subdistrict, Muara Enim Regency, South Sumatra 31352)",
        "PT RMK Energy, Tbk (Jalan TPA RT. 33, Keramasan Musi 2, Kertapati Subdistrict, Palembang City, South Sumatra 30149)",
        "PT Keza Lintas Buana (Gn. Cahya, Buay Rawan Subdistrict, OKU Selatan Regency, South Sumatra 32211)",
        "PT Agro Gading Sejahtera (Gn. Cahya, Buay Rawan Subdistrict, OKU Selatan Regency, South Sumatra 32211)",
        "PT Mega Hijau Bersama (MHBK Site: Kepayang Village & MHBM Site: Merang Village, Bayung Lencir Subdistrict, Musi Banyuasin Regency, South Sumatra)",
        "PT Binakarya Eramandiri (Mangsang Village, Bayung Lencir Subdistrict, Musi Banyuasin Regency, South Sumatra)",
        "PT Arwana Anugerah Keramik (Palembang – Prabumulih Hwy KM. 34, Tanjung Pering, Indralaya Utara, Ogan Ilir, South Sumatra)",
        "PT Buana Global Mandiri (Trans Sumatera Toll Road Betung Section Project, Simpang Sekayu Tempino – Jambi Section 2B)",
      ],
      note:
