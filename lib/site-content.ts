...
export const siteContent: Record<Locale, SiteDictionary> = {
  id: {
    ...
    customers: {
      ...
      items: [
        { name: "PT Raja Samudra Jaya", location: "Area Kerja PT. Kalidareh Prima Mandiri, Bayung Lencir, Sumatera Selatan" },
        { name: "PT Putri Melati Asih", location: "Area Kerja PLTU Ombilin, Sawah Lunto, Padang, Sumatera Barat" },
        { name: "PT Soga Teknik Utama", location: "Area Kerja PT. Pupuk Sriwijaja, Palembang, Sumatera Selatan" },
        { name: "PT Energate Prima Indonesia", location: "Desa Prambatan, Kel. Abab, Kec. Penukal Abab, Kab. PALI, Sumatera Selatan" },
        { name: "PT Madya Utama Lima", location: "Desa Kerta Dewa, Kec. Talang Ubi, Kab. PALI, Sumatera Selatan" },
        { name: "PT Rasita Anugrah Mulia", location: "Site PT. RAM Belani, Muaratara, Sumatera Selatan" },
        { name: "PT Global Integra Energy", location: "Desa Prambatan, Kel. Abab, Kec. Penukal Abab, Kab. PALI, Sumatera Selatan" },
        { name: "PT Sumatera Bara Utama", location: "IUP PT. TMP, Desa Kota Raya, Kec. Lahat, Kab. Lahat, Sumatera Selatan" },
        { name: "PT MNC Infrastruktur Utama", location: "Site APE Arthaco Prima Energy, Babat Supat, Musi Banyuasin, Sumatera Selatan" },
        { name: "PT GH EMM Indonesia", location: "Dusun II, Desa Gunung Raja, Kec. Rambang Dangku, Kab. Muara Enim, Sumatera Selatan" },
        { name: "PT Royaltama Mulia Kontraktorindo, Tbk", location: "Emplasemen RMKO, Jalan Lintas Prabumulih – Muara Enim No. 16, Gn. Megang Dalam, Kec. Gn. Megang, Kab. Muara Enim, Sumatera Selatan 31352" },
        { name: "PT RMK Energy, Tbk", location: "Jalan TPA RT. 33, Keramasan Musi 2, Kec. Kertapati, Kota Palembang, Sumatera Selatan 30149" },
        { name: "PT Keza Lintas Buana", location: "Gn. Cahya, Kec. Buay Rawan, Kab. OKU Selatan, Sumatera Selatan 32211" },
        { name: "PT Agro Gading Sejahtera", location: "Gn. Cahya, Kec. Buay Rawan, Kab. OKU Selatan, Sumatera Selatan 32211" },
        { name: "PT Mega Hijau Bersama", location: "Site MHBK: Desa Kepayang & Site MHBM: Desa Merang, Kec. Bayung Lencir, Kab. Musi Banyuasin, Sumatera Selatan" },
        { name: "PT Binakarya Eramandiri", location: "Desa Mangsang, Kec. Bayung Lencir, Kab. Musi Banyuasin, Sumatera Selatan" },
        { name: "PT Arwana Anugerah Keramik", location: "Jalan Raya Palembang – Prabumulih KM. 34, Tanjung Pering, Indralaya Utara, Ogan Ilir, Sumatera Selatan" },
        { name: "PT Buana Global Mandiri", location: "Proyek Jalan Tol Trans Sumatera Ruas Betung, Simpang Sekayu Tempino – Jambi Seksi 2B" },
      ],
      note:
  ...
  en: {
    ...
    customers: {
      ...
      items: [
        { name: "PT Raja Samudra Jaya", location: "Work Area of PT. Kalidareh Prima Mandiri, Bayung Lencir, South Sumatra" },
        { name: "PT Putri Melati Asih", location: "Work Area of PLTU Ombilin, Sawah Lunto, Padang, West Sumatra" },
        { name: "PT Soga Teknik Utama", location: "Work Area of PT. Pupuk Sriwijaja, Palembang, South Sumatra" },
        { name: "PT Energate Prima Indonesia", location: "Prambatan Village, Abab Subdistrict, Penukal Abab, PALI Regency, South Sumatra" },
        { name: "PT Madya Utama Lima", location: "Kerta Dewa Village, Talang Ubi Subdistrict, PALI Regency, South Sumatra" },
        { name: "PT Rasita Anugrah Mulia", location: "Site of PT. RAM Belani, Muaratara, South Sumatra" },
        { name: "PT Global Integra Energy", location: "Prambatan Village, Abab Subdistrict, Penukal Abab, PALI Regency, South Sumatra" },
        { name: "PT Sumatera Bara Utama", location: "IUP PT. TMP, Kota Raya Village, Lahat Subdistrict, Lahat Regency, South Sumatra" },
        { name: "PT MNC Infrastruktur Utama", location: "APE Arthaco Prima Energy Site, Babat Supat, Musi Banyuasin, South Sumatra" },
        { name: "PT GH EMM Indonesia", location: "Dusun II, Gunung Raja Village, Rambang Dangku Subdistrict, Muara Enim Regency, South Sumatra" },
        { name: "PT Royaltama Mulia Kontraktorindo, Tbk", location: "RMKO Emplacement, Lintas Prabumulih – Muara Enim St. No. 16, Gn. Megang Dalam, Gn. Megang Subdistrict, Muara Enim Regency, South Sumatra 31352" },
        { name: "PT RMK Energy, Tbk", location: "Jalan TPA RT. 33, Keramasan Musi 2, Kertapati Subdistrict, Palembang City, South Sumatra 30149" },
        { name: "PT Keza Lintas Buana", location: "Gn. Cahya, Buay Rawan Subdistrict, OKU Selatan Regency, South Sumatra 32211" },
        { name: "PT Agro Gading Sejahtera", location: "Gn. Cahya, Buay Rawan Subdistrict, OKU Selatan Regency, South Sumatra 32211" },
        { name: "PT Mega Hijau Bersama", location: "MHBK Site: Kepayang Village & MHBM Site: Merang Village, Bayung Lencir Subdistrict, Musi Banyuasin Regency, South Sumatra" },
        { name: "PT Binakarya Eramandiri", location: "Mangsang Village, Bayung Lencir Subdistrict, Musi Banyuasin Regency, South Sumatra" },
        { name: "PT Arwana Anugerah Keramik", location: "Palembang – Prabumulih Hwy KM. 34, Tanjung Pering, Indralaya Utara, Ogan Ilir, South Sumatra" },
        { name: "PT Buana Global Mandiri", location: "Trans Sumatera Toll Road Betung Section Project, Simpang Sekayu Tempino – Jambi Section 2B" },
      ],
      note:
